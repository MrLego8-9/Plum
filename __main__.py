...
parser.add_argument("--update", help="Update Plum", action="store_true")
parser.add_argument("--update-rules", help="update the coding style rules", action="store_true", dest="updaterules")
