...
tar -czvf "plum.tar.gz" __main__.py plum_update.sh VERSION code-style-checker code_style_c.py code_style_haskell.py vera++ lambdananas vera++-lib install_release.sh
